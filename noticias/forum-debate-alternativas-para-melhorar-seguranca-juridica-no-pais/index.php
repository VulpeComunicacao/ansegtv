                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Fórum debate alternativas para melhorar segurança jurídica no país</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i> AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>23/05/2022 - 12h48</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <figure class="pull-right m-2 text-right">
                            <img src="../../img/uploads/2022/05/forum-seguranca.jpg" width="450" height="auto" alt="Forum - Segurança Jurídica" class=" img-fluid">	
                            <figcaption></figcaption>
                        </figure>

                        <p class="article"> Também palestraram o juiz federal do Trabalho, Marlos Melek, o ex-advogado-geral da União, Luís Inácio Adams, a procuradora da República, Thaméa Danelon, o ex-ministro do STF (Supremo Tribunal Federal), Marco Aurélio Mello, os deputados federais Marco Bertaiolli (PSD-SP), coordenador da Frente Parlamentar do Empreendedorismo, e Joaquim Passarinho (PL-PA), além do renomado jurista e professor Ives Gandra Martins, o grande homenageado do dia.</p>

                        <p class="article"> Os participantes concordaram que o excesso de normas provoca insegurança jurídica, o que prejudica o crescimento do país, o empreendedorismo e a geração de novos empregos.</p>
