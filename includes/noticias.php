                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item active">
                                <div class="news-block">
                                    ...
                                    <div class="news-des">
                                    Bastante aguardado pela sociedade, o novo teste de Regulamento de Dosimetria e Aplicação de Sanções Administrativas por descumprimento à LGPD (Lei Geral de Proteção de Dados Pessoais) foi publicado na segunda-feira (27) pela ANPD (Autoridade Nacional de Proteção de Dados).
                                    <br>
                        ...
                        <div class="card-body">
                            <div class="news-title">
                                <h3 class=" title-small">
                                    <a href="./noticias/estatuto-do-aprendiz-e-necessario-mas-mantem-trechos-preocupantes/">Estatuto do Aprendiz é necessário, mas mantém trechos preocupantes</a>
                                </h3>
                            </div>
                            <div class="time-text">
