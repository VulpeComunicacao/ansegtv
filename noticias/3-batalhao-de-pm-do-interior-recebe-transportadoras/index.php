                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>3⁰ Batalhão de PM do Interior recebe transportadoras</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i> AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>23/11/2021 - 9h55</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <p class="article">O diretor de Comunicação da ANSEGTV (Associação Nacional de Segurança e Transporte de Valores), Robson Alexandre Barbara, visitou no dia 19 de novembro o 3⁰ Batalhão de Polícia Militar do Interior, na cidade de Ribeirão Preto (SP). Na ocasião, foi recebido, ao lado de representantes de transportadoras de valores e do Seret (Setor de Retaguarda e Tesouraria) do Banco do Brasil, pelo tenente-coronel Rodrigo Quintino, comandante da corporação.</p>

                        <p class="article">No encontro, foi proposta a criação de um plano de integração entre todas as partes visando o fortalecimento da segurança no entorno das bases das transportadoras. O assunto deverá voltar a ser debatido em futuras reuniões. </p>

                        
                        <figure class="pull-left m-2 text-left">
                            <img src="../../img/uploads/2021/11/batalhao-pm.png" width="450" height="auto" alt="Batalhão da PM - Interior" class=" img-fluid">	
                            <figcaption></figcaption>
                        </figure>

                        <p class="article">Robson apresentou a estrutura e os objetivos da ANSEGTV, colocando-se à disposição do comandante para novas conversas.</p>

                        <p class="article">"Reuniões com autoridades, que visam aumentar a segurança da atividade de transporte de valores, são muito importantes. Agradecemos o convite e seguimos sempre abertos ao diálogo", disse Robson.</p>
