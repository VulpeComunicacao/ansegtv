                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>ANPD divulga regras para sanções por descumprimento à LGPD</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i> AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>01/03/2023 - 9h50</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <p class="article">Bastante aguardado pela sociedade, o Regulamento de Dosimetria e Aplicação de Sanções Administrativas por descumprimento à LGPD (Lei Geral de Proteção de Dados Pessoais) foi publicado na segunda-feira (27) pela ANPD (Autoridade Nacional de Proteção de Dados).</p>

                        <p class="article">Segundo o órgão, a norma tem como objetivos definir os critérios e parâmetros para as sanções pecuniárias e não pecuniárias - bem como as formas e dosimetrias para o cálculo do valor-base das multas - e proporcionar maior segurança jurídica e transparência para todos os envolvidos.</p>

                        <figure class="pull-right m-2 text-left">
                                <img src="../../img/uploads/2023/03/regulamento-anpd.png" width="450" height="auto" alt="Regulamento ANPD" class=" img-fluid">	
                                <figcaption></figcaption>
                        </figure>
                        
                        <p class="article">Poderão ser aplicadas todas as sanções já previstas na LGPD: advertência; multa simples, de até 2% do faturamento da empresa, limitada, no total, a R$ 50 milhões, por infração; multa diária, com limite total de R$ 50 milhões; publicização da infração; bloqueio dos dados pessoais; eliminação dos dados pessoais; suspensão parcial do funcionamento do banco de dados, por no máximo de seis meses, prorrogável por igual período, até que se regularize a situação; suspensão do exercício da atividade de tratamento dos dados pessoais por no máximo de seis meses, prorrogável por igual período; proibição parcial ou total do exercício de atividades relacionadas a tratamento de dados.</p>
                            
                        <p class="article">As sanções serão aplicadas depois de uma análise feita em processo administrativo caso a caso, conforme os seguintes critérios: gravidade e natureza das infrações e dos direitos pessoais afetados; boa-fé do infrator; vantagem auferida ou pretendida pelo infrator; condição econômica do infrator; reincidência; grau do dano; cooperação do infrator; adoção de mecanismos e procedimentos internos capazes de minimizar o dano; adoção de política de boas práticas e governança; pronta adoção de medidas corretivas; e proporcionalidade entre a gravidade da falta e a intensidade da sanção.</p>
                        
                        <p class="article">Ainda de acordo com a ANPD, o modelo de fiscalização será responsivo, ou seja, não apenas com a aplicação de sanções, mas com a adoção de medidas orientativas e preventivas para reconduzir os agentes de tratamento à conformidade com a LGPD. O regulamento entra em vigor imediatamente.</p>
                        
                        <p class="article">Resolução: <a href="https://www.gov.br/anpd/pt-br/assuntos/noticias/anpd-publica-regulamento-de-dosimetria/Resolucaon4CDANPD24.02.2023.pdf" target="_blank">https://www.gov.br/anpd/pt-br/assuntos/noticias/anpd-publica-regulamento-de-dosimetria/Resolucaon4CDANPD24.02.2023.pdf</a></p>
