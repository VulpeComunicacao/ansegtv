...
<html lang="pt-BR">
        <!-- Head Section -->
        <head>
            <title>Joiandro Carvalho assume a presidência da ANSEGTV 
            </title>
            ...
            <meta property="og:title" content="Joiandro Carvalho assume a presidência da ANSEGTV 
">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Joiandro Carvalho assume a presidência da ANSEGTV </h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i> ANSEGTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>13/02/2026 - 15h42</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <p class="article">O novo presidente da ANSEGTV (Associação Nacional de Segurança e Transporte de Valores), Joiandro Carvalho, tomou posse no dia 26 de novembro de 2025, após uma Assembleia Geral Extraordinária que contou com a presença de toda a diretoria da associação.
                        </p>

                        <figure class="pull-right m-2 text-left">
                                <img src="../../img/uploads/2026/02/joiandro-ansegtv.png" width="450" height="auto" alt="Joiandro Carvalho, novo presidente da ANSEGTV" class=" img-fluid">	
                                <figcaption</figcaption>
                        </figure>

                        <p class="article">Atualmente Superintendente de Segurança e Infraestrutura da TBForte – uma das empresas associadas à ANSEGTV – Joiandro Carvalho assume a presidência reafirmando o compromisso de atuar em defesa dos interesses das empresas que prestam serviços de segurança, transporte de valores, gestão de ciclo numerário, custódia, logística de valores, entre outras atividades do setor. Ele aproveitou o momento para agradecer e parabenizar ao Vanderlei Reis pela condução da presidência da ANSEGTV nos últimos dezoito meses.
                        </p>
                        
                        <p class="article">E na mesma ocasião, a ANSEGTV também reforçou os seus valores institucionais, destacando a defesa da livre concorrência, da abertura de mercado, da ética nas relações empresariais e do cumprimento rigoroso dos princípios legais.</p>
