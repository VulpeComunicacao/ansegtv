                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Economia no transporte de valores</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i>  AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>12/08/2020 - 16h35</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 content-news">
                            <p class="article">O Confaz (Conselho Nacional de Política Fazendária) e a Secretaria da Receita Federal do Brasil definiram no dia 30 de julho que a nova GTV-e (Guia de Transporte de Valores Eletrônica) será obrigatória a partir de setembro de 2022. As empresas, no entanto, já podem optar pelo novo documento a partir de setembro deste ano.</p>
                            <p class="article">A GTV-e substitui a antiga GTV e o Extrato de Faturamento, que haviam sido instituídos em 22 de agosto de 1989. Nela, deverão constar dados que discriminam a carga, como a quantidade de volumes/malotes, espécie do valor (numerário, cheques, moeda, outros) e valor declarado de cada espécie.</p>
                            <figure class="pull-right m-2 text-right">
                                <img src="../../img/uploads/2020/08/receita_federal_totem_12-08.png" width="480" height="auto" alt="Superintendência da Receita Federal" class=" img-fluid">	
                                <figcaption> Foto: Marcelo Camargo/Agência Brasil.</figcaption>
                            </figure>
                            <p class="article">Segundo Andrey Ferreira, Assessor Tributário da ANSEGTV (Associação Nacional de Segurança e Transporte de Valores), os ganhos para o setor são vários. “Com a digitalização, economizaremos em impressão, manutenção, horas perdidas com preenchimentos manuais e no espaço necessário para estocagem dos documentos. O acesso à informação também será mais fácil. Sem contar a integração online com a Sefaz (Secretaria da Fazenda), além da maior sustentabilidade”.</p>
                            <br>
                            <br>
                        </div>
