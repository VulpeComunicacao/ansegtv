                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Esquadra deixa mercado de transporte de valores</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i>  AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>12/12/2019 - 17h18</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 content-news">
                            <p class="article">A Associação Nacional de Segurança e Transporte de Valores (Ansegtv) lamentou o encerramento das atividades de transporte de valores da Esquadra, membro do grupo que operava em quatro estados — além da sede mineira.</p>
                            <img src="../../img/uploads/2019/12/imagem_nota_esquadra.jpeg" width="490" height="auto" alt="Frota da Esquadra" class="pull-right m-2 img-fluid">
                            <p class="article">Em comunicado divulgado nesta terça-feira (10), a empresa afirmou que apresentava dificuldades de concorrer no mercado com as gigantes Prosegur, Protege e Brink’s, que detêm aproximadamente 90% do serviço de transportes de valores.</p>  
                            <p class="article">A Esquadra tem mais de 7 mil funcionários em segurança patrimonial e serviços, e voltará seu foco a estes principais nichos de mercado.</p>
                        </div>
