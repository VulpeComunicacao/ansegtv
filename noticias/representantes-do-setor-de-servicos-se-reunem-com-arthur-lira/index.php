...
<html lang="pt-BR">
        <!-- Head Section -->
        <head>
            <title>Representantes do setor de serviços se reúnem com Arthur Lira | ANSEGTV</title>
            <meta name="description" content="O deputado Laércio Oliveira promoveu na última terça-feira (15) um encontro entre as entidades apoiadoras da Frente Parlamentar do Setor de Serviços (FPS), a qual comanda, com o presidente da Câmara dos Deputados, Arthur Lira, para tratar da Reforma Tributária." />
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Representantes do setor de serviços se reúnem com Arthur Lira</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i> AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i> 17/06/2021 - 15h55</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 content-news">
                            ...
                            <p class="article">O deputado Laércio Oliveira promoveu na última terça-feira (15) um encontro entre as entidades apoiadoras da Frente Parlamentar do Setor de Serviços (FPS), a qual comanda, com o presidente da Câmara dos Deputados, Arthur Lira, para tratar da Reforma Tributária.</p>
                            
                            <figure class="pull-right m-2 text-left">
                                    <img src="../../img/uploads/2021/06/reuniao-fps-com-arthur-lira.jpg" width="450" height="auto" alt="Representantes reunidos com Arthur Lira" class=" img-fluid">	
                                    <figcaption></figcaption>
                            </figure>

                            <p class="article">A ANSEGTV foi representada por Milena Oliveira, Relações Institucionais da associação.</p>


                            <p class="article">Na reunião, Laércio defendeu que não haja aumento de impostos para o setor com a Reforma Tributária e destacou que a oneração dos segmentos de serviços resultará na diminuição do emprego no país.</p>

                            <p class="article">Lira afirmou que o texto não deverá onerar o setor, já que há uma preocupação com a oferta de emprego. Ele destacou ainda que será discutida uma alíquota especial para serviços e varejo.</p>

                            <p class="article">De acordo com os dados da Base do Cadastro Nacional Central de Empresas – CEMPRE, o setor de serviços representa 76% das empresas ativas no país e 72% das pessoas ocupadas. Do total de empresas, 60% dos segmentos do setor de serviços são representados pelas entidades que apoiam a FPS.</p>
