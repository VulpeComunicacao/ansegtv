                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Avaliação de riscos e integridade é tema de encontro em SP</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i> AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>24/11/2022 - 10h</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <figure class="pull-right m-2 text-right">
                                <img src="../../img/uploads/2022/11/evento-avaliacao.png" width="450" height="auto" alt="Equipe ANSGETV em Feira de Segurança" class=" img-fluid">	
                                <figcaption></figcaption>
                            </figure>

                        <p class="article">A evolução da integridade e dos controles de combate à corrupção no Brasil desde a publicação da Lei Anticorrupção, em 2013, foram alguns dos temas debatidos.</p>
