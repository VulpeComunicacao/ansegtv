    ...
    <div class="container">
        ...
        <div class="row estrutura mb-4">
            ...
            <div class="col-md-5 my-3">
                <img src="../img/icon-building.png" alt="6 Empresas" loading="lazy">
                <p>FORMADA POR <strong>6 EMPRESAS</strong> DE SEGURANÇA E TRANSPORTE DE VALORES </p>
            </div>
            <div class="col-md-4 my-3 estados">
                <img src="../img/icon_map.png" alt="Presente em 21 Estados Brasileiros + DF" loading="lazy">
                <p><strong>21 ESTADOS</strong><br> BRASILEIROS + DF</p>
            </div>
            <div class="col-md-3 my-3 bases-operacionais">
                <img src="../img/icon-factory.png" alt="44 Bases operacionais" loading="lazy">
                <p><strong>44 BASES</strong><br> OPERACIONAIS</p>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                     ...
                     <div class="box-mapa">
                        <svg id="map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="465" height="465">
                            <g class="model-orange">
                                ...
                                <a href="box_ba" id="state_ba" class="state" data-state="ba" xlink:href="">
                                ...
                                <a href="box_al" id="state_al" class="state" data-state="al" xlink:href="">
                                ...
                                <a href="box_pe" id="state_pe" class="state" data-state="pe" xlink:href="">
                                ...
                                <a href="box_se" id="state_se" class="state" data-state="se" xlink:href="">
                               ...
                               <!-- <a href="box_am" id="state_am" class="state" data-state="am" xlink:href=""> -->
                                ...
                                <a href="box_pa" id="state_pa" class="state" data-state="pa" xlink:href="">
                                ...
                                <a href="box_ro" id="state_ro" class="state" data-state="ro" xlink:href="">
                                ...
                                <!-- <a href="box_ac" id="state_ac" class="state" data-state="ac" xlink:href=""> -->
                                ...
                                <a href="box_ap" id="state_ap" class="state" data-state="ap" xlink:href="">
                                ...
                                <a href="box_rj" id="state_rj" class="state" data-state="rj" xlink:href="">
                                ...
                                <a href="box_rs" id="state_rs" class="state" data-state="rs" xlink:href="">
                               ...
                               <!--  <a href="#" id="state_sc" class="state" data-state="sc" xlink:href=""> -->
                                ...
                                <a href="box_pr" id="state_pr" class="state" data-state="pr" xlink:href="">
                                ...
                                <a href="box_sp" id="state_sp" class="state" data-state="sp" xlink:href="">
                                ...
                                <a href="box_ms" id="state_ms" class="state" data-state="ms" xlink:href="">
                                ...
                                <a href="box_go" id="state_go" class="state" data-state="go" xlink:href="">
                                ...
                                <a href="box_es" id="state_es" class="state" data-state="es" xlink:href="">
                                ...
                                <a href="box_pi" id="state_pi" class="state" data-state="pi" xlink:href="">
                                ...
                                <a href="box_ce" id="state_ce" class="state" data-state="ce" xlink:href="">
                                ...
                                <a href="box_to" id="state_to" class="state" data-state="to" xlink:href="">
                                ...
                                <a href="box_ma" id="state_ma" class="state" data-state="ma" xlink:href="">
                                ...
                                <a href="box_rn" id="state_rn" class="state" data-state="rn" xlink:href="">
                                ...
                                <a href="box_pb" id="state_pb" class="state" data-state="pb" xlink:href="">
                                ...
                                <a href="box_df" id="state_df" class="state" data-state="df" xlink:href="">
                    ...
                    <div class="empresas">
                        ...
                        <div id="box_ac" data-info="ac" class="estado"></div>
                        ...
                        <div id="box_am" data-info="am" class="estado"></div>
                        ...
                        <div id="box_rr" data-info="rr" class="estado"></div>
                        <div id="box_sc" data-info="sc" class="estado"></div>
