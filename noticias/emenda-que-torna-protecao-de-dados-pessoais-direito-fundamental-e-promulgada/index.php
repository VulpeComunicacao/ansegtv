                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Emenda que torna proteção de dados pessoais direito fundamental é promulgada</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i> AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>14/02/2022 - 12h25</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <p class="article">O Congresso Nacional promulgou na quinta-feira (10) a Emenda Constitucional (EC 115), que altera a Constituição e inclui a proteção de dados pessoais entre os direitos e garantias fundamentais. O texto também fixa a competência privativa da União para legislar sobre proteção e tratamento de dados pessoais.</p>

                        <figure class="pull-left m-2 text-left">
                            <img src="../../img/uploads/2022/02/plenario-votacao.jpg" width="450" height="auto" alt="Votação no Plenário" class=" img-fluid">	
                            <figcaption>Jefferson Rudy/Agência Senado</figcaption>
                        </figure>
                        
                        <p class="article">A EC 115 teve origem na Proposta de Emenda à Constituição (PEC) 17/2019, aprovada pelo Senado em outubro do ano passado. Apresentada pelo senador Eduardo Gomes (MDB-TO) e relatada pela senadora Simone Tebet (MDB-MS), a PEC atribui à União as competências de organizar e fiscalizar a proteção e o tratamento de dados pessoais, de acordo com a LGPD (Lei Geral de Proteção de Dados), aprovada em 2018 e em vigor desde setembro de 2020.</p>
